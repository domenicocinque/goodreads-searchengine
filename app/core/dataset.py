...
class BookDatasetBuilder:
    ...
    def download_single_html(self, id: str, force: bool = False) -> None:
        """Download the webpage of a single book. The force parameter can be used to force
        the download even if the file already exists. This is useful if the file is corrupted 
        or if the webpage has changed since the last download."""
